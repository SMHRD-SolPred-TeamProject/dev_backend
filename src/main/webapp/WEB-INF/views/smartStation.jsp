...
<div class="container-fluid page-header py-5 mb-5">
    <div class="container py-5">
        <h1 class="display-3 text-white mb-3 animated slideInDown">Smart Energy</h1>
        ...
        <div class="row g-0 mx-lg-0">
            <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                <div class="p-lg-5 ps-lg-0">
                    ...
                    <h1 class="mb-4">Smart Station</h1>
                    <p class="mb-4 pb-2">솔캐스터는 정류장 지붕을 태양전지로 교체 설치하여,<br>
                        이산화탄소를 배출하지 않는 친환경 에너지를 사용해 지구환경보전에 기여하고 있습니다</p>
                    <div class="row g-4">
                        <div class="col-6">
            ...
            <div class="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px">
                <div class="position-relative h-100">
                    <img class="position-absolute img-fluid w-100 h-100" src="img/smartStation.jpg" style="object-fit: cover"
                         alt="" />
                </div>
            </div>
        </div>
