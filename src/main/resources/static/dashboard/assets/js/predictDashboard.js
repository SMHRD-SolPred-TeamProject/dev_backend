...
setInterval(function (){
  fetch('http://59.0.236.34:9090/api/preGetAOD')
  // fetch('http://192.168.0.8:9090/api/preGetAOD')
      .then(res => res.json())
      .then(res => {
...
let aod = [];
let aod2 = [];
fetch('http://59.0.236.34:9090/api/getPreAOD')
// fetch('http://192.168.0.8:9090/api/getPreAOD')
    .then(res => res.json())
    .then(res => {
