...
<head>
    ...
    <title>Solcaster join page</title>
        ...
        <div class="input-form col-md-12">
            ...
            <form class="validation-form ScoreDream400" style="align-items: center" action="joinInsert" method="post" novalidate>
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="aggrement" style="margin-left: 130px">개인정보 수집 및 이용에 동의합니다.</label>
                </div>
                <div class="mb-4"></div>
                <button class="join joinBtn, btn btn-warning btn-lg" type="submit" style="margin: 0 auto">
                    가입하기
                </button>
            </form>
        </div>
