...
<div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="owl-carousel header-carousel position-relative">
        <div
                ...
                data-dot="<img src='img/mainImage1.jpg'>"
        >
        ...
        <div
                class="owl-carousel-item position-relative"
                data-dot="<img src='img//mainImage2.jpg'>"
        >
        ...
        <div
                class="owl-carousel-item position-relative"
                data-dot="<img src='img/mainImage3.jpg'>"
        >
        ...
        <div class="row g-0 mx-lg-0">
            ...
            >
                <div class="video position-relative h-100">
                    <iframe width="600" height="350" src="https://www.youtube.com/embed/QPUjV7epJqE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<div class="container-xxl py-5">
    <div class="container">
        <div
                ...
                style="max-width: 600px"
        >
            <h5 class="text-primary">Solcaster는</h5>
            <h1 class="mb-4">고객의 우수한 평가와 함께합니다</h1>
        </div>
        <div
        ...
        >
            <div class="testimonial-item text-center">
                ...
                <div class="testimonial-text text-center rounded p-4">
                    ...
                    <h5 class="mb-1">John Jun Suh</h5>
                    <span class="fst-italic">기업사용자</span>
                </div>
            </div>
            <div class="testimonial-item text-center">
                <div class="testimonial-img position-relative">
                ...
                <div class="testimonial-text text-center rounded p-4">
                    ...
                    <h5 class="mb-1">jungwoo</h5>
                    <span class="fst-italic">(사)한국스마트팜산업협회</span>
                </div>
            </div>
            <div class="testimonial-item text-center">
                <div class="testimonial-img position-relative">
                ...
                <div class="testimonial-text text-center rounded p-4">
                    ...
                    <h5 class="mb-1">Jeno</h5>
                    <span class="fst-italic">개인사용자</span>
                </div>
            </div>
        </div>
    </div>
