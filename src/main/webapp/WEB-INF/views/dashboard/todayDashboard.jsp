...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/pages/todayDashboard.html" target="_blank">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white" href="../pages/todayDashboard.html">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="../pages/predictDashboard.html">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="../pages/solution.html">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="../pages/dashboardLogin.html">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul class="navbar-nav  justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        <a href="../pages/dashboardLogin.html" class="nav-link text-body font-weight-bold px-0">
                    ...
                    <div class="card card-a">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <h4 class="text-sm mb-0 text-capitalize ScoreDream600">실시간 발전량</h4>
                ...
                <div>
                    <div class="card card-a marginleft15">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <h4 class="text-sm mb-0 text-capitalize ScoreDream600">실시간 누적발전량</h4>
                ...
                <div>
                    <div class="card card-b marginleft15">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <h4 class="text-sm mb-0 text-capitalize ScoreDream600">예측률</h4>

                                <!-- 여기 예측률이 나와야함! -->
                                <h3 class="mb-0 ScoreDream500">97.3<span class="text-success text-sm font-weight-bolder">ㅤ%</span>
                                </h3>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            ...
                            <p class="mb-0 ScoreDream400"><span
                                    class="text-success text-sm font-weight-bolder ScoreDream400">22.05.12
                  </span>기준
                                계산된 예측률입니다.
                            </p>
                        </div>
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        <div
                            ...
                            <i class="material-icons opacity-10">filter_drama</i>
                        </div>
                        <div class="text-end pt-1">
                            <h6 class="text-m mb-0 text-capitalize ScoreDream600">now weather</h6>
                            <div class="weather">
                                <div class="CurrIcon">
            ...
            <div class="card z-index-2 ">
                    ...
                    <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                        <div class="chart">
                            ...
                            <figure class="highcharts-figure">
                                ...
                                <p class="highcharts-description ScoreDream500 font-white">
                                    ㅤ실시간 발전량 차트는 10초 단위로 생성되며, 이 전 데이터는 그래프에서 삭제됩니다.
                                </p>
                            </figure>
                            <!-- 그래프 end -->
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex ">
                        ...
                        <p class="mb-0 text-sm ScoreDream400"> 혹시 뭔가 넣을 말이 있을까봐 남겨놓음 </p>
                    </div>
                </div>
            </div>
            <!-- card end -->
                    ...
                    <div class="bg-gradient-secondary shadow-secondary border-radius-lg py-3 pe-1">
                        <div class="chart">
                            ...
                            <figure class="highcharts-figure">
                                ...
                                <p class="highcharts-description ScoreDream500 font-white">
                                    ㅤ실시간 누적 발전량 차트는 10초 단위로 생성되며, 어쩌고 저쩌고~~~
                                </p>
                            </figure>
                        </div>
                    </div>
